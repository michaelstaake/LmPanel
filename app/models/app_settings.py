...
class AppSettings(Base):
    ...
    notification_server_errors_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    notification_ip_blocked_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    notification_user_login_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    notification_user_registers_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    notification_usage_limit_reached_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    mail_email_address: Mapped[str | None] = mapped_column(String(255), nullable=True)
    mail_email_username: Mapped[str | None] = mapped_column(String(255), nullable=True)
    mail_email_password: Mapped[str | None] = mapped_column(String(512), nullable=True)
    mail_email_server: Mapped[str | None] = mapped_column(String(255), nullable=True)
