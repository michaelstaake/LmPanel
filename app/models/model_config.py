...
class ModelConfig(Base):
    ...
    anpu_architecture: Mapped[str | None] = mapped_column(String(64), nullable=True)
    anpu_compatible: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    anpu_flm_tag: Mapped[str | None] = mapped_column(String(120), nullable=True)
    anpu_conversion_status: Mapped[str] = mapped_column(String(32), default="none", nullable=False)
    anpu_conversion_error: Mapped[str] = mapped_column(Text, default="", nullable=False)
