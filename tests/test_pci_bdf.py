...
class ParseVulkaninfoBdfByIndexTests(unittest.TestCase):
    ...
    def test_normalize_8_digit_domain(self) -> None:
        # Some tools zero-pad the domain to 8 hex digits (e.g. "00000000:01:00.0"),
        # unlike vulkaninfo/sysfs which use 4. Both must normalize to the same value.
